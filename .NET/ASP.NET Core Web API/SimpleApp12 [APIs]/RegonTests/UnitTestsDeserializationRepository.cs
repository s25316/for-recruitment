...
{
    public class UnitTestsDeserializationRepository
    {
        private readonly ITestOutputHelper _output;

        public UnitTestsDeserializationRepository(ITestOutputHelper output)
        {
            _output = output;
        }

        [Fact]
        public void DeserializationRepository_DeserializeResponseFromZalogujRequestAndReturnSid_Correct()
        {
            //Arrange
            var deserialization = new DeserializationRepository();
            var xml = "<s:Envelope xmlns:s=\"http://www.w3.org/2003/05/soap-envelope\" xmlns:a=\"http://www.w3.org/2005/08/addressing\"><s:Header><a:Action s:mustUnderstand=\"1\">http://CIS/BIR/PUBL/2014/07/IUslugaBIRzewnPubl/ZalogujResponse</a:Action></s:Header><s:Body><ZalogujResponse xmlns=\"http://CIS/BIR/PUBL/2014/07\"><ZalogujResult>zx599x259bncr6ut2rzy</ZalogujResult></ZalogujResponse></s:Body></s:Envelope>";

            //Act
            var result = deserialization.DeserializeResponseFromZalogujRequestAndReturnSid(xml);
        ...
        [Fact]
        public void DeserializationRepository_DeserializeResponseFromZalogujRequestAndReturnSid_UserKeyException_EmptySid()
        {
            //Arrange
            var deserialization = new DeserializationRepository();
            var xml = "<s:Envelope xmlns:s=\"http://www.w3.org/2003/05/soap-envelope\" xmlns:a=\"http://www.w3.org/2005/08/addressing\"><s:Header><a:Action s:mustUnderstand=\"1\">http://CIS/BIR/PUBL/2014/07/IUslugaBIRzewnPubl/ZalogujResponse</a:Action></s:Header><s:Body><ZalogujResponse xmlns=\"http://CIS/BIR/PUBL/2014/07\"><ZalogujResult></ZalogujResult></ZalogujResponse></s:Body></s:Envelope>";

            //Act
            //Assert
            var ex = Assert.Throws<UserKeyException>(() => deserialization.DeserializeResponseFromZalogujRequestAndReturnSid(xml));
            _output.WriteLine(ex.Message);
        }

        [Fact]
        public void DeserializationRepository_DeserializeResponseFromZalogujRequestAndReturnSid_RegonAppException_IncorrectZalogujResponse()
        {
            //Arrange
            var xml = "<s:Envelope xmlns:s=\"http://www.w3.org/2003/05/soap-envelope\" xmlns:a=\"http://www.w3.org/2005/08/addressing\"><s:Header><a:Action s:mustUnderstand=\"1\">http://CIS/BIR/PUBL/2014/07/IUslugaBIRzewnPubl/ZalogujResponse</a:Action></s:Header><s:Body><ZalogujResponsez xmlns=\"http://CIS/BIR/PUBL/2014/07\"><Zaloguj>zx599x259bncr6ut2rzy</Zaloguj></ZalogujResponsez></s:Body></s:Envelope>";
            var deserialization = new DeserializationRepository();

            //Act
            //Assert
            var ex = Assert.Throws<AppException>(() => deserialization.DeserializeResponseFromZalogujRequestAndReturnSid(xml));
            _output.WriteLine(ex.Message);
        }
        //==================================================================================================================================================================================
        //==================================================================================================================================================================================
        ...
        [Fact]
        public void DeserializationRepository_DeserializeResponseFromWylogujRequestAndReturnStatus_RegonAppException_IncorrectWylogujResponse()
        {
            //Arrange
            var xml = "<s:Envelope xmlns:s=\"http://www.w3.org/2003/05/soap-envelope\" xmlns:a=\"http://www.w3.org/2005/08/addressing\"><s:Header><a:Action s:mustUnderstand=\"1\">http://CIS/BIR/PUBL/2014/07/IUslugaBIRzewnPubl/WylogujResponse</a:Action></s:Header><s:Body><WylogujResponsez xmlns=\"http://CIS/BIR/PUBL/2014/07\"><WylogujResult>true</WylogujResult></WylogujResponsez></s:Body></s:Envelope>";
            var deserialization = new DeserializationRepository();

            //Act
            //Assert
            var ex = Assert.Throws<AppException>(() => deserialization.DeserializeResponseFromWylogujRequestAndReturnStatus(xml));
            _output.WriteLine(ex.Message);
        }

        [Fact]
        public void DeserializationRepository_DeserializeResponseFromWylogujRequestAndReturnStatus_Correct()
        {
            //Arrange
            var deserialization = new DeserializationRepository();
            ...
            //Act
            var result = deserialization.DeserializeResponseFromWylogujRequestAndReturnStatus(xml);
        ...
        [Fact]
        public void DeserializationRepository_DeserializeResponseFromDaneSzukajToDanePodstawowe_Correct()
        {
            //Arrange
            var deserialization = new DeserializationRepository();
            var xml = "<s:Envelope xmlns:s=\"http://www.w3.org/2003/05/soap-envelope\" xmlns:a=\"http://www.w3.org/2005/08/addressing\"><s:Header><a:Action s:mustUnderstand=\"1\">http://CIS/BIR/PUBL/2014/07/IUslugaBIRzewnPubl/DaneSzukajResponse</a:Action></s:Header><s:Body><DaneSzukajResponse xmlns=\"http://CIS/BIR/PUBL/2014/07\"><DaneSzukajResult>&lt;root&gt;&#xD;&lt;dane&gt;&#xD;&lt;Regon&gt;00033150100000&lt;/Regon&gt;&#xD;&lt;RegonLink&gt;&amp;lt;a href='javascript:danePobierzPelnyRaport(\"00033150100000\",\"DaneRaportPrawnaPubl\", 0);'&amp;gt;000331501&amp;lt;/a&amp;gt;&lt;/RegonLink&gt;&#xD;&lt;Nazwa&gt;GŁÓWNY URZĄD STATYSTYCZNY&lt;/Nazwa&gt;&#xD;&lt;Wojewodztwo&gt;MAZOWIECKIE&lt;/Wojewodztwo&gt;&#xD;&lt;Powiat&gt;Warszawa&lt;/Powiat&gt;&#xD;&lt;Gmina&gt;Śródmieście&lt;/Gmina&gt;&#xD;&lt;Miejscowosc&gt;Warszawa&lt;/Miejscowosc&gt;&#xD;&lt;KodPocztowy&gt;00-925&lt;/KodPocztowy&gt;&#xD;&lt;Ulica&gt;Aleja Niepodległości&lt;/Ulica&gt;&#xD;&lt;Typ&gt;P&lt;/Typ&gt;&#xD;&lt;SilosID&gt;6&lt;/SilosID&gt;&#xD;&lt;/dane&gt;&#xD;&lt;/root&gt;</DaneSzukajResult></DaneSzukajResponse></s:Body></s:Envelope>\r\n";

            //Act
            var result = deserialization.DeserializeResponseFromDaneSzukajToDanePodstawowe(xml, new Exception("ZZZ"));

            //Assert
            Assert.Equal("GŁÓWNY URZĄD STATYSTYCZNY", result.Nazwa);
            Assert.Equal(6, result.SilosID.Value);
        }

        [Fact]
        public void DeserializationRepository_DeserializeResponseFromDaneSzukajToDanePodstawowe_RegonAppException_IncorrectDaneSzukajResponse()
        {
            //Arrange
            var deserialization = new DeserializationRepository();
            var xml = "<s:Envelope xmlns:s=\"http://www.w3.org/2003/05/soap-envelope\" xmlns:a=\"http://www.w3.org/2005/08/addressing\"><s:Header><a:Action s:mustUnderstand=\"1\">http://CIS/BIR/PUBL/2014/07/IUslugaBIRzewnPubl/DaneSzukajResponse</a:Action></s:Header><s:Body><DaneSzukajResponsez xmlns=\"http://CIS/BIR/PUBL/2014/07\"><DaneSzukajResult>&lt;root&gt;&#xD;&lt;dane&gt;&#xD;&lt;Regon&gt;00033150100000&lt;/Regon&gt;&#xD;&lt;RegonLink&gt;&amp;lt;a href='javascript:danePobierzPelnyRaport(\"00033150100000\",\"DaneRaportPrawnaPubl\", 0);'&amp;gt;000331501&amp;lt;/a&amp;gt;&lt;/RegonLink&gt;&#xD;&lt;Nazwa&gt;GŁÓWNY URZĄD STATYSTYCZNY&lt;/Nazwa&gt;&#xD;&lt;Wojewodztwo&gt;MAZOWIECKIE&lt;/Wojewodztwo&gt;&#xD;&lt;Powiat&gt;Warszawa&lt;/Powiat&gt;&#xD;&lt;Gmina&gt;Śródmieście&lt;/Gmina&gt;&#xD;&lt;Miejscowosc&gt;Warszawa&lt;/Miejscowosc&gt;&#xD;&lt;KodPocztowy&gt;00-925&lt;/KodPocztowy&gt;&#xD;&lt;Ulica&gt;Aleja Niepodległości&lt;/Ulica&gt;&#xD;&lt;Typ&gt;P&lt;/Typ&gt;&#xD;&lt;SilosID&gt;6&lt;/SilosID&gt;&#xD;&lt;/dane&gt;&#xD;&lt;/root&gt;</DaneSzukajResult></DaneSzukajResponsez></s:Body></s:Envelope>\r\n";

            //Act
            //Assert
            var ex = Assert.Throws<AppException>(() => deserialization.DeserializeResponseFromDaneSzukajToDanePodstawowe(xml, new Exception("exeptionMessage")));
            _output.WriteLine(ex.Message);
        }

        [Fact]
        public void DeserializationRepository_DeserializeResponseFromDaneSzukajToDanePodstawowe_RegonAppException_IncorrectDane()
        {
            //Arrange
            var deserialization = new DeserializationRepository();
            var xml = "<s:Envelope xmlns:s=\"http://www.w3.org/2003/05/soap-envelope\" xmlns:a=\"http://www.w3.org/2005/08/addressing\"><s:Header><a:Action s:mustUnderstand=\"1\">http://CIS/BIR/PUBL/2014/07/IUslugaBIRzewnPubl/DaneSzukajResponse</a:Action></s:Header><s:Body><DaneSzukajResponse xmlns=\"http://CIS/BIR/PUBL/2014/07\"><DaneSzukajResult>&lt;root&gt;&#xD;&lt;danez&gt;&#xD;&lt;Regon&gt;00033150100000&lt;/Regon&gt;&#xD;&lt;RegonLink&gt;&amp;lt;a href='javascript:danePobierzPelnyRaport(\"00033150100000\",\"DaneRaportPrawnaPubl\", 0);'&amp;gt;000331501&amp;lt;/a&amp;gt;&lt;/RegonLink&gt;&#xD;&lt;Nazwa&gt;GŁÓWNY URZĄD STATYSTYCZNY&lt;/Nazwa&gt;&#xD;&lt;Wojewodztwo&gt;MAZOWIECKIE&lt;/Wojewodztwo&gt;&#xD;&lt;Powiat&gt;Warszawa&lt;/Powiat&gt;&#xD;&lt;Gmina&gt;Śródmieście&lt;/Gmina&gt;&#xD;&lt;Miejscowosc&gt;Warszawa&lt;/Miejscowosc&gt;&#xD;&lt;KodPocztowy&gt;00-925&lt;/KodPocztowy&gt;&#xD;&lt;Ulica&gt;Aleja Niepodległości&lt;/Ulica&gt;&#xD;&lt;Typ&gt;P&lt;/Typ&gt;&#xD;&lt;SilosID&gt;6&lt;/SilosID&gt;&#xD;&lt;/danez&gt;&#xD;&lt;/root&gt;</DaneSzukajResult></DaneSzukajResponse></s:Body></s:Envelope>\r\n";
        ...
        [Fact]
        public void DeserializationRepository_DeserializeResponseFromDaneSzukajToDanePodstawowe_Exception_IncorrectRoot()
        {
            //Arrange
            var deserialization = new DeserializationRepository();
            var exeptionMessage = "My 01";
            var xml = "<s:Envelope xmlns:s=\"http://www.w3.org/2003/05/soap-envelope\" xmlns:a=\"http://www.w3.org/2005/08/addressing\"><s:Header><a:Action s:mustUnderstand=\"1\">http://CIS/BIR/PUBL/2014/07/IUslugaBIRzewnPubl/DaneSzukajResponse</a:Action></s:Header><s:Body><DaneSzukajResponse xmlns=\"http://CIS/BIR/PUBL/2014/07\"><DaneSzukajResult>&lt;roots&gt;&#xD;&lt;dane&gt;&#xD;&lt;Regon&gt;00033150100000&lt;/Regon&gt;&#xD;&lt;RegonLink&gt;&amp;lt;a href='javascript:danePobierzPelnyRaport(\"00033150100000\",\"DaneRaportPrawnaPubl\", 0);'&amp;gt;000331501&amp;lt;/a&amp;gt;&lt;/RegonLink&gt;&#xD;&lt;Nazwa&gt;GŁÓWNY URZĄD STATYSTYCZNY&lt;/Nazwa&gt;&#xD;&lt;Wojewodztwo&gt;MAZOWIECKIE&lt;/Wojewodztwo&gt;&#xD;&lt;Powiat&gt;Warszawa&lt;/Powiat&gt;&#xD;&lt;Gmina&gt;Śródmieście&lt;/Gmina&gt;&#xD;&lt;Miejscowosc&gt;Warszawa&lt;/Miejscowosc&gt;&#xD;&lt;KodPocztowy&gt;00-925&lt;/KodPocztowy&gt;&#xD;&lt;Ulica&gt;Aleja Niepodległości&lt;/Ulica&gt;&#xD;&lt;Typ&gt;P&lt;/Typ&gt;&#xD;&lt;SilosID&gt;6&lt;/SilosID&gt;&#xD;&lt;/dane&gt;&#xD;&lt;/roots&gt;</DaneSzukajResult></DaneSzukajResponse></s:Body></s:Envelope>\r\n";

            //Act
            //Assert
            var result = Assert.Throws<Exception>(() => deserialization.DeserializeResponseFromDaneSzukajToDanePodstawowe(xml, new Exception(exeptionMessage)));
            Assert.Equal(exeptionMessage, result.Message);
        }
        //==================================================================================================================================================================================
        //==================================================================================================================================================================================
        //==================================================================================================================================================================================
        ...
        [Fact]
        public void DeserializationRepository_DeserializeResponseFromDanePobierzPelnyRaport_Correct_DaneJednostkiPrawnej()
        {
            //Arrange
            ...
            if (result is DaneJednostkiPrawnej pra)
            {
                Assert.Equal("GŁÓWNY URZĄD STATYSTYCZNY", pra.PrawNazwa);
                Assert.Equal("PODMIOTY UTWORZONE Z MOCY USTAWY", pra.PrawRodzajRejestruEwidencjiNazwa);
            }
        }

        [Fact]
        public void DeserializationRepository_DeserializeResponseFromDanePobierzPelnyRaport_Correct_PublDaneRaportDzialalnoscFizycznejCeidg()
        {
            //Arrange
            ...
            if (result is DaneJednostkiFizycznejCeidg fiz)
            {
                Assert.Equal("xxxxxxxxxxxxxx", fiz.FizNazwa);
                Assert.Equal("CENTRALNA EWIDENCJA I INFORMACJA O DZIAŁALNOŚCI GOSPODARCZEJ", fiz.FizCRodzajRejestruNazwa);
            }
        }

        [Fact]
        public void DeserializationRepository_DeserializeResponseFromDanePobierzPelnyRaport_Correct_PublDaneRaportDzialalnoscFizycznejRolnicza()
        {
            //Arrange
            ...
            if (result is DaneJednostkiFizycznejRolnicza fiz)
            {
                Assert.Equal("GOSPODARSTWO ROLNE", fiz.FizNazwa);
                Assert.Equal("Yyyyyy", fiz.FizAdSiedzMiejscowoscPocztyNazwa);
            }
        }

        [Fact]
        public void DeserializationRepository_DeserializeResponseFromDanePobierzPelnyRaport_Correct_PublDaneRaportDzialalnoscFizycznejPozostala()
        {
            //Arrange
            ...
            if (result is DaneJednostkiFizycznejPozostala fiz)
            {
                Assert.Equal("NIEPUBLICZNY ZAKŁAD OPIEKI ZDROWOTNEJ xxxxxxxxxxxxx", fiz.FizNazwa);
                Assert.Equal("PODMIOTY NIE PODLEGAJĄCE WPISOM DO REJESTRU LUB EWIDENCJI", fiz.FizPRodzajRejestruNazwa);
            }
        }

        [Fact]
        public void DeserializationRepository_DeserializeResponseFromDanePobierzPelnyRaport_Correct_PublDaneRaportDzialalnoscFizycznejWKrupgn()
        {
            //Arrange
            ...
            if (result is DaneJednostkiFizycznejWKrupgn fiz)
            {
                Assert.Equal("xxxxxxxxxxxxxxxx", fiz.FizNazwa);
                Assert.Equal("ul. Bystrzycka", fiz.FizAdSiedzUlicaNazwa);
            }
        }

        //Dane Syntestyczne, Wygenerowane na podstawie Pliku żrodłowego XML
        [Fact]
        public void DeserializationRepository_DeserializeResponseFromDanePobierzPelnyRaport_Correct_DaneJednostkiLokalnaFizycznej()
        {
            //Arrange
        ...
        public void DeserializationRepository_DeserializeResponseFromDanePobierzPelnyRaport_Correct_DaneJednostkiLokalnaPrawnej()
        {
            ...
            if (result is DaneJednostkiLokalnaPrawnej lok)
            {
                Assert.Equal("12345678901234", lok.LokprawRegon14);
                Assert.Equal("Handlowy", lok.LokprawRodzajRejestruEwidencjiNazwa);
            }
        }
        ...
        //Uncorrect Data
        [Fact]
        public void DeserializationRepository_DeserializeResponseFromDanePobierzPelnyRaport_RegonAppException_IncorrectDanePobierzPelnyRaportResult()
        {
            //Arrange
            var dane = $"<s:Envelope xmlns:s=\"http://www.w3.org/2003/05/soap-envelope\" xmlns:a=\"http://www.w3.org/2005/08/addressing\"><s:Header><a:Action s:mustUnderstand=\"1\">http://CIS/BIR/PUBL/2014/07/IUslugaBIRzewnPubl/DanePobierzPelnyRaportResponse</a:Action></s:Header><s:Body><DanePobierzPelnyRaportResponse xmlns=\"http://CIS/BIR/PUBL/2014/07\"><DanePobierzPelnyRaportResults><root></root></DanePobierzPelnyRaportResults></DanePobierzPelnyRaportResponse></s:Body></s:Envelope>";
            dane = dane.Replace("\r\n    ", "");
            ...
            //Act
            //Assert
            var ex = Assert.Throws<AppException>(() => deserialization.DeserializeResponseFromDanePobierzPelnyRaport(dane, nazwaRaportu));
            _output.WriteLine(ex.Message);
        }

        [Fact]
        public void DeserializationRepository_DeserializeResponseFromDanePobierzPelnyRaport_RegonAppException_EmptyRoot()
        {
            //Arrange
            var dane = $"<s:Envelope xmlns:s=\"http://www.w3.org/2003/05/soap-envelope\" xmlns:a=\"http://www.w3.org/2005/08/addressing\"><s:Header><a:Action s:mustUnderstand=\"1\">http://CIS/BIR/PUBL/2014/07/IUslugaBIRzewnPubl/DanePobierzPelnyRaportResponse</a:Action></s:Header><s:Body><DanePobierzPelnyRaportResponse xmlns=\"http://CIS/BIR/PUBL/2014/07\"><DanePobierzPelnyRaportResult></DanePobierzPelnyRaportResult></DanePobierzPelnyRaportResponse></s:Body></s:Envelope>";
            //var dane = $"<s:Envelope xmlns:s=\"http://www.w3.org/2003/05/soap-envelope\" xmlns:a=\"http://www.w3.org/2005/08/addressing\"><s:Header><a:Action s:mustUnderstand=\"1\">http://CIS/BIR/PUBL/2014/07/IUslugaBIRzewnPubl/DanePobierzPelnyRaportResponse</a:Action></s:Header><s:Body><DanePobierzPelnyRaportResponse xmlns=\"http://CIS/BIR/PUBL/2014/07\"><DanePobierzPelnyRaportResult><root></root></DanePobierzPelnyRaportResult></DanePobierzPelnyRaportResponse></s:Body></s:Envelope>";
            dane = dane.Replace("\r\n    ", "");
        ...
        [Fact]
        public void DeserializationRepository_DeserializeResponseFromDanePobierzPelnyRaport_RegonAppException_EmptyDane()
        {
            //Arrange
            var dane = "";
            var xml = InputDaneToDanePobierzPelnyRaportResponse(dane);
            ...
            //Act
            //Assert
            var ex = Assert.Throws<AppException>(() => deserialization.DeserializeResponseFromDanePobierzPelnyRaport(xml, nazwaRaportu));
            _output.WriteLine(ex.Message);
        }
        //====================================================================================================================================================================================
        //Private Methods
