...
using SimpleApp11__EF__CdF_JWT_.Middlewares;
using System.Text;

namespace SimpleApp11__EF__CdF_JWT_
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContext<PortalDBContext>( opt => opt.UseSqlServer("name=DBString"));
            ...
            }).AddJwtBearer(opt =>
            {
                ...
                opt.TokenValidationParameters = new TokenValidationParameters
                {
                    ...
                    ValidIssuer = builder.Configuration.GetSection("SecretKeys")["Issuer"],//Who is ISSUER
                    ValidAudience = builder.Configuration.GetSection("SecretKeys")["Audience"],
                    IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(
                        builder.Configuration.GetSection("SecretKeys")["Secret1"] ??
            ...
            //Here Add \"UseAuthentication\" Before \"UseAuthorization\"
