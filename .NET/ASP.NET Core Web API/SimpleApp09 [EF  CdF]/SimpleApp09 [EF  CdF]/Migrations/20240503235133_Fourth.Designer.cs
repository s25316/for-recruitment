...
namespace SimpleApp09__EF__CdF_.Migrations
{
    ...
    [Migration("20240503235133_Fourth")]
            ...
            modelBuilder.Entity("SimpleApp09__EF__CdF_.DatabaseLayer.Models.Album", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdLabel = 1,
                            NameAlbum = "Syrenki",
                            ReleaseDate = new DateTime(2024, 5, 4, 1, 51, 33, 375, DateTimeKind.Local).AddTicks(8267)
                        },
                        new
                        {
                            IdAlbum = 2,
                            ...
                            ReleaseDate = new DateTime(2024, 5, 4, 1, 51, 33, 375, DateTimeKind.Local).AddTicks(8316)
                        });
                });
